...
import TrantsportTypeSelector from "../../components/TransportTypeSelector";
...
const EditTransport = ({ navigation }) => {
    ...
    editTransport(
      {
        ...
        transport_type: state.transportTypeLabel,
        cost: state.cost,
  ...
  useEffect(() => {
    ...
    dispatch(
      setOrderData({
        ...
        transportType: currentOrder.transport_type_label,
      })
    );
  }, [id]);
  ...
  return (
    <>
      <View style={styles.container}>
        ...
        <Text style={styles.addTransportText}>Transportni o'zgartirish</Text>
      </View>
      <ScrollView>
